...
DOWNLOAD_DIR=${BUILD_DIR:-$SRC_DIR/downloads}
...
PYTHON_DEP_NAMES=(numpy dateutil pandas scipy matplotlib pyflakes statsmodel ipython \
  dataextract)
if [[ -d $INSTALL_DIR ]]
then
...
# setuptools TODO is this required here?
